var iValidation = function () {
    ...
    var Validate = function (controlId) {
        ...
        $(controlId + ' input[type="text"].validation,input[type="password"].validation').each(function() {
    ...
    var initializeEvents = function() {
        ...
        $(document).on('keyup', 'input[type="text"].validation,input[type="password"].validation', function () {
            ValidateInput($(this));
        });
